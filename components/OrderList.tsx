                         ...
                         <div className="p-2 overflow-y-auto flex-1 custom-scrollbar space-y-2">
                            {columnOrders.map(order => (
                                <div 
                                    ...
                                    className="bg-white dark:bg-slate-800 p-3 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition-all cursor-pointer group select-none relative"
                                >
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 font-medium border-b border-slate-200 dark:border-slate-800">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 font-semibold w-[25%]">采购来源 / 平台单号 (tiktok)</th>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="space-y-2 pt-1">
                                                    {order.supplierTrackingNumber ? (
                                                        <div onClick={(e) => open17Track(order.supplierTrackingNumber!, e)} className="group/supplier cursor-pointer relative overflow-hidden bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm hover:border-blue-400 transition-all">
                                                             <div className="absolute left-0 top-0 bottom-0 w-1 bg-blue-400"></div>
                                                             <div className="px-3 py-2 pl-4">
                                                                <div className="flex items-center justify-between mb-1">
                                                                    <span className="text-[10px] uppercase tracking-wider text-slate-400 font-bold flex items-center gap-1"><Truck size={10} /> 商家自发货</span>
                                                                    <ExternalLink size={10} className="text-blue-400 opacity-0 group-hover/supplier:opacity-100 transition-opacity" />
                                                                </div>
                                                                <div className="font-mono text-xs text-slate-600 dark:text-slate-300 font-bold tracking-wide group-hover/supplier:text-blue-600 transition-colors">{order.supplierTrackingNumber}</div>
                                                             </div>
                                                        </div>
                                                    ) : <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg border border-dashed border-slate-200 dark:border-slate-800 text-slate-400 text-[10px]">待商家自发货</div>}
                                                </div>
                                        ...
                                        <td className="px-4 py-4 align-top">
                                            <div className="space-y-3">
                                                <div className="flex flex-wrap items-center gap-2">
                                                    <span className="px-2 py-0.5 rounded text-[11px] font-bold bg-slate-100 text-slate-600 border border-slate-200">{order.platform}</span>
                                                    {order.platformOrderId && <span className="text-[11px] font-mono text-slate-500" title="平台采购跟踪号">#{order.platformOrderId}</span>}
                                                </div>
                                                {order.trackingNumber ? (
                                                    <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-2 shadow-sm">
                                                        <div className="text-[9px] uppercase tracking-wider text-slate-400 font-bold mb-1">平台订单号 (tiktok)</div>
                                                        <div className="font-mono text-[11px] text-slate-600 dark:text-slate-300 font-bold tracking-wide truncate">{order.trackingNumber}</div>
                                                    </div>
                                                ) : <div className="text-[10px] text-slate-300 italic pl-1">暂无平台订单号</div>}
                                            </div>
                                        </td>
